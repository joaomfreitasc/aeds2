...
class Lista {
    ...
    public void remover(int pos) throws Exception {
        int tamanho = tamanho();
        if (inicio == fim || pos < 0 || pos >= tamanho) {
            throw new Exception("ERRO");
        } else if (pos == 0) {
            removerInicio();
    ...
    private Celula partition(Celula esq, Celula dir) {
        ...
        for (Celula j = esq; j != dir; j = j.prox) {
            if (((Personagem.statecmpr(j.elemento, dir.elemento)) < 0)
                    || ((Personagem.statecmpr(j.elemento, dir.elemento) == 0)
                            && (Personagem.strcmpr(j.elemento, dir.elemento)) < 0)) {
                i = (i == null) ? esq : i.prox;
                swap(i, j);
            }
        }
...
class Personagem {
    ...
    Personagem(String id, String name, String house, String ancestry, String especies, String patronus,
            Boolean hogwartsStudent, String actorName, String eyeColour,
    ...
    // Modificar os atributos privados
    ...
    public void setHairColour(String[] alternate_names) {
        this.alternate_names = alternate_names;
    }
    ...
    public void setWizard(LocalDate dateOfBirth) {
        this.dateOfBirth = dateOfBirth;
    }
    ...
    public static String[] lerAlternate_names(String linha) {
        ...
        if (inicio == fim - 1) {
            ...
            // Separar o vetor de alternate_names
            linha = linha.substring(inicio + 1, fim);

            String[] aux = linha.split(", ");

            // adicionar as string formatadas em um vet auxiliar
            String[] resp = new String[aux.length];
    ...
    public void imprimir() {
        ...
        System.out.println(this.id + " ## " + this.name + " ## " + printAlternateNames(alternate_names) + " ## "
                + this.house + " ## " + this.ancestry + " ## " + this.especies + " ## " + this.patronus + " ## " +
                this.hogwartsStaff + " ## " + this.hogwartsStudent + " ## " + this.actorName + " ## " + this.alive
                + " ## " + data + " ## " + this.yearOfBirth + " ## " +
    ...
    public static void startPlayers() {
        ...
        try {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                // ler a linha e setar os atributos
    ...
    public static Personagem persquisar(String id, ArrayList<Personagem> personagem) {
        ...
        for (int i = 0; i < personagem.size(); i++) {
            ...
            if (personagem.get(i).getId().equals(id))
                return personagem.get(i);
        }
    ...
    public static boolean pesquisaSequencial(Personagem[] personagens, String nome) {
        for (int i = 0; i < personagens.length; i++) {
            // Check if the current character's name matches the search string
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ler todo o arquivo csv gerando os personagens
        startPlayers();
