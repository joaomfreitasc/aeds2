...
public class Q05 {
    public static boolean PesquisaSequencial(String nome, ArrayList<Personagem> lista) {
    ...
    public static void insetionsort(Personagem[] array, int n) {
        for (int i = 1; i < n; i++) {
